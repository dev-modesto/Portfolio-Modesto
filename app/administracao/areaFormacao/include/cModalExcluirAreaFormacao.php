<?php
    ...
    if(isset($_POST['click-excluir-area-formacao'])){
...
<div class="modal fade" id="modalExcluir" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalExcluir" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="was-validated form-container" action="include/eAreaFormacao.php" method="post">
                <input type="text" name="id-area" id="id-area" value="<?php echo $id ?>" hidden>
