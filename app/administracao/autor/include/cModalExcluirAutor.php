<?php
    ...
    if(isset($_POST['click-excluir-autor'])){
...
<div class="modal fade" id="modalExcluir" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalExcluir" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="was-validated form-container" action="include/eAutor.php" method="post">
                <input type="text" name="id-autor" id="id-autor" value="<?php echo $id ?>" hidden>
